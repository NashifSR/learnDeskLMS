  ...
  return (
    ...
    >
      ...
      <p className="max-w-2xl mx-auto text-gray-600 mb-12 text-base sm:text-lg">
        আপনার কি কোন প্রশ্ন আছে অথবা আপনার মেয়েকে কি ভর্তি করতে চান? ফোন, হোয়াটসঅ্যাপ, অথবা আমাদের যোগাযোগ ফর্মের মাধ্যমে আমাদের সাথে যোগাযোগ করুন।
      </p>
        ...
        <div className="space-y-6 text-left">
          ...
          <div className="flex items-center gap-3">
            ...
            <span className="text-gray-700">
              আল ফুরক্বান ইসলামিয়া বালিকা মাদ্রাসা, প্রফেসর পাড়া, লতিফপুর বাজারের পাশে, গোড়াই, মির্জাপুর, টাঙ্গাইল
            </span>
          </div>
